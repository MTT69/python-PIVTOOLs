...
%
    ...
    % Print the number of modes being removed
    fprintf('POD Filter - Batch (images %d-%d): Removing %d modes from frame1, %d modes from frame2\n', ...
            imRange(1), imRange(end), N_auto1, N_auto2);
