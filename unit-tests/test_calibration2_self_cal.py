"""Stereo self-calibration tests for the calibration2 package.

The C-extension-free tests below exercise the calibration2 bridge, the dewarp world
...
``test_calibration2_self_cal_recovery.py`` and skips cleanly when the lib is absent.
"""
...
from pivtools_gui.calibration2 import self_cal as SC
from pivtools_gui.calibration2.camera_model import CameraModel
from pivtools_gui.calibration2.stereo_model import reconstruct_3c_field
...
def test_pinhole_from_model_bridges_fields():
    ...
    # The bridged camera projects identically to the calibration2 model.
