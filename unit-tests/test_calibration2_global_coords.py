"""Unit tests for calibration2.global_coords.compute_camera_shifts (datum chain)."""

import numpy as np
import pytest

from pivtools_gui.calibration2.camera_model import CameraModel, DistortionModel
from pivtools_gui.calibration2.global_coords import compute_camera_shifts
from pivtools_gui.calibration2.record import MonoRecord
