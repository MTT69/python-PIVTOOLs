"""Hermetic tests for the stepped-board 3D polynomial model (calibration2, S7).
...
from pivtools_gui.calibration2.record import WorldFrame
from pivtools_gui.calibration2.stereo_model import camera_z_sign, reconstruct_3c_at_points
