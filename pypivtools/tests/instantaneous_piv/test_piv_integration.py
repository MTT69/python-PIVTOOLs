...
from pypivtools.tests.helpers import assert_arrays_close, compare_matrices
...
class InstantaneousPIVTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inpaint_patcher = patch(
            "pypivtools.piv.piv_backend.cpu_instantaneous.InstantaneousCorrelatorCPU._inpaint_nans_biharm",
        ...
        self._worker_patcher = patch(
            "pypivtools.piv.piv_backend.cpu_instantaneous.get_worker",
